...
class Upload {
    ...
    function upload($file) {
		...
		$this->translation['file_error'] = __('file_error', 'Hata oluştu. Lütfen tekrar deneyiniz.');
		$this->translation['local_file_missing'] = __('local_file_missing', 'Dosya bulunamadı.');
		$this->translation['local_file_not_readable'] = __('local_file_not_readable', 'Dosya okunamadı.');
		$this->translation['uploaded_too_big_ini'] = __('uploaded_too_big_ini', 'Hata oluştu (izin verilen boyuttan büyük dosya yükleyemezsiniz. Ancak php.ini dosyasından upload_max_filesize değerini yükselterek tekrar deneyebilirsiniz.).');
		$this->translation['uploaded_too_big_html'] = __('uploaded_too_big_html', 'Hata oluştu (sayfanızda belirttiğiniz MAX_FILE_SIZE boyutundan büyük bir dosya yükleyemezsiniz.).');
		$this->translation['uploaded_partial'] = __('uploaded_partial', 'Hata oluştu (dosyanın sadece bir kısmı yüklenebildi).');
		$this->translation['uploaded_missing'] = __('uploaded_missing', 'Hata oluştu (dosya seçilmemiş).');
		$this->translation['uploaded_unknown'] = __('uploaded_unknown', 'Hata oluştu (hata tespit edilemedi).');
		$this->translation['try_again'] = __('try_again', 'Hata oluştu. Lütfen tekrar deneyiniz.');
		$this->translation['file_too_big'] = __('file_too_big', 'Dosya izin verilenden daha büyük.');
		$this->translation['no_mime'] = __('no_mime', 'Dosya türü bulunamadı.');
		$this->translation['incorrect_file'] = __('incorrect_file', 'Bu dosyanın uzantısı geçersiz.');
		$this->translation['image_too_wide'] = __('image_too_wide', 'Resim izin verilenden daha geniş.');
		$this->translation['image_too_narrow'] = __('image_too_narrow', 'Resim izin verilenden daha dar.');
		$this->translation['image_too_high'] = __('image_too_high', 'Resim izin verilenden daha uzun.');
		$this->translation['image_too_short'] = __('image_too_short', 'Resim izin verilenden daha kısa.');
		$this->translation['ratio_too_high'] = __('ratio_too_high', 'Resim oranı çok yüksek (resim çok geniş).');
		$this->translation['ratio_too_low'] = __('ratio_too_low', 'Resim oranı çok düşük (resim çok uzun).');
		$this->translation['too_many_pixels'] = __('too_many_pixels', 'Resim izin verilenden büyük.');
		$this->translation['not_enough_pixels'] = __('not_enough_pixels', 'Resim izin verilenden küçük.');
		$this->translation['file_not_uploaded'] = __('file_not_uploaded', 'Dosya yüklenemedi. İşlem sonlandırıldı.');
		$this->translation['already_exists'] = __('already_exists', '%s dosyası zaten var. Lütfen dosyanızın ismini değiştirerek tekrar deneyiniz.');
		$this->translation['temp_file_missing'] = __('temp_file_missing', 'Temp dizini doğru belirtilmemiş. İşlem sonlandırıldı.');
		$this->translation['source_missing'] = __('source_missing', 'Dosyanızın içeriğinde izin verilmeyen unsurlar var. İşlem sonlandırıldı.');
		$this->translation['destination_dir'] = __('destination_dir', 'Dosyaların yükleneceği dizin oluşturulamadı. İşlem sonlandırıldı.');
		$this->translation['destination_dir_missing'] = __('destination_dir_missing', 'Dosyaların yükleneceği dizin oluşturulmamış. İşlem sonlandırıldı.');
		$this->translation['destination_path_not_dir'] = __('destination_path_not_dir', 'Dosyaların yükleneceği adres bir dizin değil. İşlem sonlandırıldı.');
		$this->translation['destination_dir_write'] = __('destination_dir_write', 'Dosyaların yükleneceği dizinin yazma izinlerinde(CHMOD) problem var. İşlem sonlandırıldı.');
		$this->translation['destination_path_write'] = __('destination_path_write', 'Dosyaların yükleneceği adresin yazma izinlerinde(CHMOD) problem var. İşlem sonlandırıldı.');
		$this->translation['temp_file'] = __('temp_file', 'Geçici dizine (temp) yazılamıyor. İzinleri kontrol etmelisiniz. İşlem sonlandırıldı.');
		$this->translation['source_not_readable'] = __('source_not_readable', 'Dosyanın içeriği okunamadı. İşlem sonlandırıldı.');
		$this->translation['no_create_support'] = __('no_create_support', '%s dosyası oluşturulamadı.');
		$this->translation['create_error'] = __('create_error', 'Kaynaktan %s resmi oluşturulurken hata oluştu.');
		$this->translation['source_invalid'] = __('source_invalid', 'Resim dosyası okunamadı. Dosyanın bir resim olduğundan emin misiniz?');
		$this->translation['gd_missing'] = __('gd_missing', 'Sunucuda GD kütüphanesi olmadığı için işleme devam edemiyorsunuz.');
		$this->translation['watermark_no_create_support'] = __('watermark_no_create_support', '%s resmi oluşturulamadığı için filigran oluşturulamadı.');
		$this->translation['watermark_create_error'] = __('watermark_create_error', '%s resmi okunamadığı için filigran oluşturulamadı.');
		$this->translation['watermark_invalid'] = __('watermark_invalid', 'Bilinmeyen dosya türü. Filigran oluşturulamadı.');
		$this->translation['file_create'] = __('file_create', '%s dosyası oluşturulamadı.');
		$this->translation['no_conversion_type'] = __('no_conversion_type', 'Belirtilen dosya türü dönüştürülemedi.');
		$this->translation['copy_failed'] = __('copy_failed', 'Dosya kopyalanırken hata oluştu. copy() işlemi başarısız.');
		$this->translation['reading_failed'] = __('reading_failed', 'Dosya okunurken hata oluştu.');
